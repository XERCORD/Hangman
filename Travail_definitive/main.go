...
func main() {
	...
	case 1:
		...
		affichage = Affichage.ReplaceWithUnderscores(motAleatoire, lettreVisible)
	...
	case 2:
		...
		affichage = Affichage.ReplaceWithMultipleLetters(motAleatoire, indicesVisibles)
	...
	for {
		...
		case 1:
			...
			if Contains.ContainsRune(motAleatoire, lettreChoisieRune) {
				affichage = Affichage.RevealLetter(motAleatoire, affichage, lettreChoisieRune)
		...
		if !Contains.ContainsUnderscore(affichage) {
